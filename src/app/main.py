...
def main(page: ft.Page):
    ...
    state = AppState()
    filter_dialog_view = ColumnFilterDialog(page, state)
    ...
    exec_set_question = lambda e: set_question(e, page, input_field_view, progress_dialog, error_dialog_view, card_content, QueryContentView, state)
    ...
    download_table_floating_button = DownloadTableButtonView(event_handler=lambda e: download_table(page, state))
